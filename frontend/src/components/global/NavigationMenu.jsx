    ...
    <nav className="">
      <ul className="flex items-center sm:text-lg gap-4 w-full text-white justify-start ">
        <div className="flex justify-between relative">
          <Link
            to="/"
            className="flex justify-between items-center w-full flex-nowrap text-xl sm:text-2xl gap-2 font-bold"
          >
            <svg
              ...
              aria-hidden="true"
              role="img"
              className="iconify iconify--logos max-w-6 sm:max-w-20"
              width="35.93"
              height="32"
                      ...
                      return (
                        <li key={el.id}>
                          <Link
                            ...
                            className="header-nav-link bg-white "
                          >
                            <span>{el.title} </span>
                          </Link>
                        </li>
                        ...
                        <motion.ul variants={variants}>
                          {showSubMenu[el.id] &&
                            el.child_cats.map((ele) => {
                              return (
                                <li key={ele.id} className="sub-menu-li pl-4">
                                  <Link
